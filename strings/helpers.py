...
HELP_9 = """🔥**<u>ɴᴇᴡ ғᴇᴀᴛᴜʀᴇs — ᴇxᴛʀᴀs:</u>**

🎵 **ᴀᴜᴛᴏ ᴩʟᴀʏ:**
/autoplay ᴏʀ /ap : ᴛᴏɢɢʟᴇ ᴀᴜᴛᴏ ᴩʟᴀʏ ᴏɴ/ᴏғғ ᴡɪᴛʜ ʙᴜᴛᴛᴏɴ ᴩᴀɴᴇʟ
/autoplay on : ᴇɴᴀʙʟᴇ ᴀᴜᴛᴏ ᴩʟᴀʏ ғᴏʀ ᴛʜɪs ɢʀᴏᴜᴩ
/autoplay off : ᴅɪsᴀʙʟᴇ ᴀᴜᴛᴏ ᴩʟᴀʏ ғᴏʀ ᴛʜɪs ɢʀᴏᴜᴩ
↪️ ᴡʜᴇɴ ǫᴜᴇᴜᴇ ᴇɴᴅs, ʙᴏᴛ ᴀᴜᴛᴏᴍᴀᴛɪᴄᴀʟʟʏ ᴩʟᴀʏs ʀᴇʟᴀᴛᴇᴅ ʏᴏᴜᴛᴜʙᴇ ᴛʀᴀᴄᴋ 🎶

🎮 **ғᴜɴ & ɢᴀᴍᴇs:**
/dice : ʀᴏʟʟ ᴀ 🎲 ᴅɪᴄᴇ
/dart : ᴛʜʀᴏᴡ ᴀ 🎯 ᴅᴀʀᴛ
/basket : sʜᴏᴏᴛ ᴀ 🏀 ʙᴀsᴋᴇᴛ
/jackpot : sᴘɪɴ ᴀ 🎰 ᴊᴀᴄᴋᴘᴏᴛ
/ball : ʀᴏʟʟ ᴀ 🎳 ʙᴀʟʟ
/football : ᴋɪᴄᴋ ᴀ ⚽ ғᴏᴏᴛʙᴀʟʟ
/love [ɴᴀᴍᴇ1] [ɴᴀᴍᴇ2] : ʟᴏᴠᴇ ᴄᴀʟᴄᴜʟᴀᴛᴏʀ 💕
/truth : ɢᴇᴛ ᴀ ᴛʀᴜᴛʜ ǫᴜᴇsᴛɪᴏɴ 🤔
/dare : ɢᴇᴛ ᴀ ᴅᴀʀᴇ ᴄʜᴀʟʟᴇɴɢᴇ 😈
/meme [ᴄᴀᴛᴇɢᴏʀʏ] : ɢᴇᴛ ᴀ ʀᴀɴᴅᴏᴍ ᴍᴇᴍᴇ 😂
/waifu : ɢᴇᴛ ᴀ ʀᴀɴᴅᴏᴍ ᴡᴀɪғᴜ ɪᴍᴀɢᴇ 🌸
/bored : ɢᴇᴛ ᴀ ʀᴀɴᴅᴏᴍ ᴀᴄᴛɪᴠɪᴛʏ sᴜɢɢᴇsᴛɪᴏɴ 🙃
/figlet [ᴛᴇxᴛ] : ᴄᴏɴᴠᴇʀᴛ ᴛᴇxᴛ ᴛᴏ ᴀsᴄɪɪ ᴀʀᴛ ✍️

🔍 **ɪɴғᴏ & ʟᴏᴏᴋᴜᴘ:**
/weather [ᴄɪᴛʏ] : ɢᴇᴛ ᴡᴇᴀᴛʜᴇʀ ɪɴғᴏ 🌤️
/ip [ᴀᴅᴅʀᴇss] : ɪᴘ ɪɴᴛᴇʟʟɪɢᴇɴᴄᴇ ʟᴏᴏᴋᴜᴘ 🌐
/domain [ᴅᴏᴍᴀɪɴ] : ᴡʜᴏɪs ᴅᴏᴍᴀɪɴ ɪɴғᴏ 🔎
/population [ᴄᴏᴜɴᴛʀʏ ᴄᴏᴅᴇ] : ᴄᴏᴜɴᴛʀʏ ᴩᴏᴩᴜʟᴀᴛɪᴏɴ & ɪɴғᴏ 🌍
/anime [ɴᴀᴍᴇ] : ᴀɴɪᴍᴇ ɪɴғᴏ ᴠɪᴀ ᴀɴɪʟɪsᴛ 🍜
/movie [ɴᴀᴍᴇ] : ᴍᴏᴠɪᴇ ɪɴғᴏ ᴠɪᴀ ᴛᴍᴅʙ 🎬
/pypi [ᴩᴀᴄᴋᴀɢᴇ] : ᴩʏᴛʜᴏɴ ᴩᴀᴄᴋᴀɢᴇ ɪɴғᴏ 🐍
/groupdata : ɢʀᴏᴜᴩ sᴛᴀᴛs & ɪɴғᴏ 📊
/qr [ᴛᴇxᴛ] : ɢᴇɴᴇʀᴀᴛᴇ ǫʀ ᴄᴏᴅᴇ 📱

🛠️ **ᴛᴏᴏʟs:**
/encode [ᴛᴇxᴛ] : ᴇɴᴄᴏᴅᴇ ᴛᴇxᴛ ᴛᴏ ʜᴇx 🔐
/decode [ʜᴇx] : ᴅᴇᴄᴏᴅᴇ ʜᴇx ᴛᴏ ᴛᴇxᴛ 🔓
/genpassword [ʟᴇɴɢᴛʜ] : ɢᴇɴᴇʀᴀᴛᴇ sᴇᴄᴜʀᴇ ᴩᴀssᴡᴏʀᴅ 🔑
/rmbg : ʀᴇᴍᴏᴠᴇ ɪᴍᴀɢᴇ ʙᴀᴄᴋɢʀᴏᴜɴᴅ (ʀᴇᴩʟʏ ᴛᴏ ᴩʜᴏᴛᴏ) 🖼️

⚔️ **ᴍᴏᴅᴇʀᴀᴛɪᴏɴ (ᴀᴅᴍɪɴs):**
/ban, /unban, /mute, /unmute : ʙᴀsɪᴄ ᴍᴏᴅᴇʀᴀᴛɪᴏɴ
/kick, /kickme, /dban, /sban : ᴋɪᴄᴋ ᴄᴏᴍᴍᴀɴᴅs
/tban [ᴛɪᴍᴇ], /tmute [ᴛɪᴍᴇ] : ᴛᴇᴍᴩ ʙᴀɴ/ᴍᴜᴛᴇ
/purge, /spurge, /del : ᴩᴜʀɢᴇ ᴍᴇssᴀɢᴇs

Powered by @Team_X_Og"""

HELP_7 = """💌**<u>ʜᴇʀᴇ ʏᴏᴜ ᴄᴀɴ ғɪɴᴅ ɴᴇᴡ ғᴇᴀᴛᴜʀᴇs:</u>**

/alive : ɴᴏᴡ ʏᴏᴜ ᴄᴀɴ ᴄʜᴇᴄᴋ ᴛᴇᴀᴍᴅᴇᴠ ᴍᴜsɪᴄ ʙᴏᴛ ɪs ᴀʟɪᴠᴇ ᴏʀ ɴᴏᴛ
/id : ᴛᴏ ᴄʜᴇᴋ ᴜsᴇʀ ᴀɴᴅ ᴄʜᴀᴛ ɪᴅ
/gcast -user -assistant -pin ᴛᴇsᴛɪɴɢ ʙʀᴏᴀᴅᴄᴀsᴛ`
/verify : ᴠᴇʀɪꜰʏ ʏᴏᴜʀsᴇʟꜰ ᴀᴛ ᴛᴇᴀᴍᴅᴇᴠ ᴅᴀᴛᴀʙᴀsᴇ"""
