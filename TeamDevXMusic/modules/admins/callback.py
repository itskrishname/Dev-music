...
from TeamDevXMusic.toolkit.panels.play import panel_markup_1, stream_markup, telegram_markup
...
async def del_back_playlist(client, CallbackQuery, _):
    ...
    if command == "Pause":
        ...
        await TeamDevXMusic.pause_stream(chat_id)
        ...
        await TeamDevXMusic.resume_stream(chat_id)
        await CallbackQuery.message.reply_text(
        ...
        await TeamDevXMusic.mute_stream(chat_id)
        await CallbackQuery.message.reply_text(
        ...
        await TeamDevXMusic.unmute_stream(chat_id)
        await CallbackQuery.message.reply_text(
